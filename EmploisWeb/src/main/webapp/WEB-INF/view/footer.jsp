...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
  ...
  <!-- JS here -->
		...
		<script src="../resource/assets/js/vendor/jquery-3.6.3.min.js"></script>
		    <script src="../resource/entreprise/entreprise.js"></script>
		    <script src="../resource/domaine.js"></script>  
		    <script src="../resource/entreprise.js"></script> 
